...
/**
  ...
  */
JSON_EXPORT QString quote(const QString &str);
/**
  ...
  */
JSON_EXPORT QVariant parse(const QByteArray &data);
/**
  ...
  */
JSON_EXPORT void parseToProperties(const QByteArray &json, QObject *obj);
/**
  ...
  */
JSON_EXPORT QByteArray generate(const QVariant &data, int indent = 0);
...
/**
  ...
  */
JSON_EXPORT bool isValidUtf8(const uchar *s, int maxLen, bool zeroInvalid = false);
/**
  * @brief Convience fucntion for @ref isValidUtf8
  */
JSON_EXPORT bool isValidUtf8(const QByteArray &data, bool zeroInvalid = false);
/**
  * @brief Convience fucntion for @ref isValidUtf8
  */
JSON_EXPORT bool isValidUtf8(const  char *s, int maxLen, bool zeroInvalid = false);
...
/**
  ...
  */
JSON_EXPORT const uchar *skipBlanks(const uchar *s, int *maxLength);
/**
  * @brief Convience fucntion for @ref skipBlanks
  */
JSON_EXPORT const  char *skipBlanks(const  char *s, int *maxLength);
...
/**
  ...
  */
JSON_EXPORT const uchar *skipRecord(const uchar *s, int *maxLength);
/**
  * @brief Convience fucntion for @ref skipRecord
  */
JSON_EXPORT const  char *skipRecord(const  char *s, int *maxLength);
...
/**
  ...
  */
JSON_EXPORT const uchar *parseValue(QVariant &fvalue, const uchar *s, int *maxLength);
/**
  * @brief Convience fucntion for @ref parseValue
  */
JSON_EXPORT const  char *parseValue(QVariant &fvalue, const  char *s, int *maxLength);
...
/**
  ...
  * @return Pointer to first non-blak char or null-pointer if error
  */
JSON_EXPORT const uchar *parseField(QString &fname, QVariant &fvalue, const uchar *s,
										int *maxLength);
/**
  * @brief Convience fucntion for @ref parseField
  */
JSON_EXPORT const  char *parseField(QString &fname, QVariant &fvalue, const  char *s,
										int *maxLength);
...
/**
  ...
  * @return Pointer to first non-blak char or null-pointer if error
  */
JSON_EXPORT const uchar *parseRecord(QVariant &res, const uchar *s, int *maxLength);
/**
  * @brief Convience fucntion for @ref parseRecord
  */
JSON_EXPORT const  char *parseRecord(QVariant &res, const  char *s, int *maxLength);

typedef bool(*generatorExt)(QString &err, QByteArray &res, const QVariant &val, int indent);

JSON_EXPORT bool generate(QByteArray &res, const QVariant &val, int indent = 0,
							  generatorExt cb = 0, QString *err = 0);

JSON_EXPORT bool generate(QByteArray &res, const QVariant &val, int indent, QString *err);
}
